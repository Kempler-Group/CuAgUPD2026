# -*- coding: utf-8 -*-
"""
Created on Thu Dec  4 14:32:16 2025
...
sample_1a = pd.read_excel(r"C:\Users\stern\OneDrive\Documents\School papers\Kempler Lab\data\XPS\Stern - XPS\Sample 1 - Annealed Au\High resolution_Post sputter1.xlsx", sheet_name = a )
sample_1b = pd.read_excel(r"C:\Users\stern\OneDrive\Documents\School papers\Kempler Lab\data\XPS\Stern - XPS\Sample 1 - Annealed Au\High resolution_Post sputter1.xlsx", sheet_name = b )
sample_1c = pd.read_excel(r"C:\Users\stern\OneDrive\Documents\School papers\Kempler Lab\data\XPS\Stern - XPS\Sample 1 - Annealed Au\High resolution_Post sputter1.xlsx", sheet_name = c )
sample_1d = pd.read_excel(r"C:\Users\stern\OneDrive\Documents\School papers\Kempler Lab\data\XPS\Stern - XPS\Sample 1 - Annealed Au\High resolution_Post sputter1.xlsx", sheet_name = d )
sample_1e = pd.read_excel(r"C:\Users\stern\OneDrive\Documents\School papers\Kempler Lab\data\XPS\Stern - XPS\Sample 1 - Annealed Au\High resolution_Post sputter1.xlsx", sheet_name = e )
...
#Silver
ax3.set_title(e)
ax3.plot(sample_1e['eV'], sample_1e['Counts / s']- min(sample_1e['Counts / s']), color = col)
...
#Silver
Ag = sample_1e['Counts / s']- min(sample_1e['Counts / s'])
print(max(Ag))
ax1.set_title(e)
ax1.plot(sample_1e['eV'], Ag/(50*max(Ag)) , color = col)
